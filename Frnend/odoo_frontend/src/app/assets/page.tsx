        ...
        <div className="modal-overlay" onClick={() => setShowRegisterModal(false)}>
          <div className="modal-content glass-card" onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={handleRegister} style={{ marginTop: '1.25rem' }}>
              ...
              {/* Dynamic Photo / Document Upload */}
              <div className="form-group">
                <label className="form-label">Attach Photo / Document</label>
                <div 
                  className="mock-upload-box" 
                  onClick={() => document.getElementById('asset-file-upload')?.click()}
                  style={isUploading ? { opacity: 0.6, pointerEvents: 'none' } : {}}
                >
                  <input 
                    type="file" 
                  ...
                  {isUploading ? (
                    ...
                    <span style={{ color: 'var(--accent)', fontWeight: 600 }}>{attachedFile.name} (Ready)</span>
                  ) : (
                    <>
